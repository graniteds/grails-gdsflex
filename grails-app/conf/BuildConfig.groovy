...
grails.project.dependency.resolution = {
    ...
    dependencies {
		compile 'org.graniteds:granite-server:3.1.1.GA'
		compile 'org.graniteds:granite-server-beanvalidation:3.1.1.GA'
		compile 'org.graniteds:granite-server-datanucleus:3.1.1.GA'
		compile 'org.graniteds:granite-server-hibernate4:3.1.1.GA'
		compile 'org.graniteds:granite-server-spring:3.1.1.GA'
		compile 'org.graniteds:granite-server-appengine:3.1.1.GA'
		compile 'org.graniteds:granite-generator-share:3.1.1.GA'
		compile 'org.graniteds.grails:granite-grails-generator:2.0.0.GA'
		compile 'org.graniteds.grails:granite-grails-springsecurity:2.0.0.GA'
